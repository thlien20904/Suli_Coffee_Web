  ...
  <svg height={h} viewBox="0 0 160 40" role="img" aria-label="Đối tác 1">
    <defs>
      <linearGradient id="g1" x1="0" x2="1">
        <stop offset="0" stopColor="#b08a38" />
    ...
    <text x="70" y="26" fontSize="16" fill="#444" fontWeight="600">
      Logistics
    </text>
  </svg>
);
const LogoB = ({ h = 32 }) => (
  <svg height={h} viewBox="0 0 160 40" role="img" aria-label="Đối tác 2">
    ...
    <text x="44" y="26" fontSize="16" fill="#444" fontWeight="600">
      Retail Group
    </text>
  </svg>
);
const LogoC = ({ h = 32 }) => (
  <svg height={h} viewBox="0 0 160 40" role="img" aria-label="Đối tác 3">
    ...
    <text x="76" y="26" fontSize="16" fill="#444" fontWeight="600">
      Fashion Co
    </text>
  </svg>
);
const LogoD = ({ h = 32 }) => (
  <svg height={h} viewBox="0 0 160 40" role="img" aria-label="Đối tác 4">
    ...
    <text x="56" y="26" fontSize="16" fill="#444" fontWeight="600">
      Supply Hub
    </text>
  </svg>
);
...
const FALLBACK_DATA_URI =
  ...
  encodeURIComponent(
    `<svg xmlns="http://www.w3.org/1000/svg" width="1600" height="900">
...
export default function About() {
  ...
  return (
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle at 30% 30%, #ffd700, #f0e6cc 60%)",
            filter: "blur(8px)",
            opacity: 0.5,
          }}
        />
          ...
          <Row className="align-items-center g-4">
            <Col lg={6}>
              ...
              <p className="text-secondary fs-5 mb-4" style={{ color: "#555" }}>
                Tinh gọn – êm ái – bền bỉ. Nghệ thuật thủ công gặp gỡ thiết kế
                hiện đại, mang đến vẻ đẹp tinh tế cho mỗi bước chân.
              </p>
            ...
            <Col lg={6}>
              <Card
                ...
                style={{ borderTop: "5px solid #d4af37", borderRadius: 10 }}
              >
                <Image
                  src={HERO_IMG}
          ...
          <Row className="mb-4 justify-content-between align-items-center">
            <Col lg={7}>
              ...
              <p className="text-muted mb-0 fs-5">
                Tôn vinh vẻ đẹp Việt qua từng thiết kế tinh xảo.
              </p>
            </Col>
            <Col lg="auto" className="d-none d-lg-block">
              <Badge
                bg="warning"
                text="dark"
                className="border-0 px-3 py-2 fw-normal"
              >
              ...
              >
                <Card.Body>
                  ...
                  <p className="mb-0 text-secondary">
                    Kiến tạo những đôi giày cao cấp, mang lại sự tự tin và thoải
                    mái tối đa cho khách hàng Việt.
                  </p>
                </Card.Body>
              </Card>
            </Col>
            <Col md={4}>
              ...
              >
                <Card.Body>
                  ...
                  <p className="mb-0 text-secondary">
                    Trở thành thương hiệu giày da được yêu thích hàng đầu tại
                    Việt Nam về thiết kế & dịch vụ.
                  </p>
                </Card.Body>
              </Card>
            </Col>
          ...
          <Row className="mb-4">
            <Col>
              <h2 className="fw-bold" style={{ color: "#333" }}>
                Điểm khác biệt của Lily
              </h2>
              <p className="text-muted mb-0 fs-5">
                Nơi chất lượng và sự tận tâm hòa quyện.
              </p>
            </Col>
          </Row>
          <Row className="g-4">
            <Col md={4}>
              <Card
                ...
                style={{ borderTop: "4px solid #d4af37", borderRadius: 10 }}
              >
                <Card.Body className="d-flex">
                  ...
                  <div>
                    <h6 className="fw-bold mb-1" style={{ color: "#333" }}>
                      Vận chuyển nhanh & đổi trả dễ
                    </h6>
                    <p className="mb-0 text-secondary">
                      Miễn phí đổi size 7 ngày. Giao hàng toàn quốc, đóng gói
                      cẩn thận.
                    </p>
                  </div>
                </Card.Body>
              ...
              >
                <Card.Body className="d-flex">
                  ...
                  <div>
                    ...
                    <p className="mb-0 text-secondary">
                      Bảo hành keo/chỉ 6 tháng. Hỗ trợ sửa chữa trọn đời sản
                      phẩm.
                    </p>
                  </div>
                </Card.Body>
            ...
            <Col md={4}>
              ...
              >
                <Card.Body className="d-flex">
                  ...
                  <div>
                    <h6 className="fw-bold mb-1" style={{ color: "#333" }}>
                      Chất liệu & hoàn thiện đỉnh cao
                    </h6>
                    <p className="mb-0 text-secondary">
                      Da bò chọn lọc, đế cao su thiên nhiên. Êm ái – bền bỉ.
                    </p>
                  </div>
                </Card.Body>
              </Card>
        ...
        <Container>
          <Row className="text-center g-4">
            <Col md={3} xs={6}>
              ...
              <small className="text-muted fs-6">Khách hàng tin yêu</small>
            </Col>
            <Col md={3} xs={6}>
              <h3 className="fw-bold mb-0" style={{ color: "#d4af37" }}>
                10+
              </h3>
              <small className="text-muted fs-6">Cửa hàng toàn quốc</small>
            </Col>
            <Col md={3} xs={6}>
              <h3 className="fw-bold mb-0" style={{ color: "#d4af37" }}>
                4.9/5
              </h3>
              <small className="text-muted fs-6">Đánh giá hài lòng</small>
            </Col>
            <Col md={3} xs={6}>
              <h3 className="fw-bold mb-0" style={{ color: "#d4af37" }}>
                24h
              </h3>
              <small className="text-muted fs-6">Hỗ trợ khách hàng</small>
            </Col>
          </Row>
          ...
          <Row className="align-items-center g-4">
            ...
            <Col lg={6}>
              <h3 className="fw-bold mb-3" style={{ color: "#333" }}>
                Trải nghiệm không gian mua sắm tinh tế
              </h3>
              <p className="text-secondary fs-5">
                Ánh sáng ấm, nội thất tối giản viền gold và kệ trưng bày cân đối
                tạo nên bầu không khí boutique sang trọng.
              </p>
        ...
        <Container>
          <Row className="mb-4 align-items-end">
            <Col>
              <h2
                className="fw-bold"
                style={{ color: "#333", letterSpacing: "0.3px" }}
              >
                Khách hàng nói về Lily
              </h2>
              <p className="text-muted mb-0">
                Trải nghiệm thực – cảm nhận thật.
              </p>
            </Col>
          ...
          >
            {[
              {
                name: "Minh Trang, Hà Nội",
                quote:
                  "Showroom sang trọng, giày đi êm và bền. Đổi size nhanh – dịch vụ quá ổn.",
              },
              {
                name: "Quốc Huy, TP.HCM",
                quote:
                  "Thiết kế tối giản nhưng tinh tế, lên chân đẹp. Da mềm, hoàn thiện rất kỹ.",
              },
              {
                name: "Thu Phương, Đà Nẵng",
                quote:
                  "Mua 3 đôi rồi vẫn hài lòng. Phối đồ đi làm hay đi chơi đều rất ổn.",
              },
            ].map((t, idx) => (
              <Carousel.Item key={idx}>
                <Row
                  className="g-4 p-4 p-md-5 align-items-center"
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(255,255,255,.95), rgba(240,230,204,.55))",
                    borderRadius: 16,
                ...
                >
                  ...
                  >
                    ...
                    >
                      <span
                        style={{ fontSize: 28, color: "#fff", lineHeight: 1 }}
                      >
                        “
                      </span>
                    </div>
                  ...
                  <Col md={11}>
                    <Card
                      ...
                      style={{
                        background: "#fff",
                        boxShadow: "0 10px 30px rgba(17,17,17,.06)",
                      }}
                    >
        ...
        <Container>
          <Row className="mb-4">
            <Col>
              ...
              <p className="text-muted mb-0">
                Một vài thắc mắc phổ biến và cách Lily hỗ trợ bạn.
              </p>
            </Col>
          </Row>
      ...
      <section
        className="py-5"
        style={{ background: "linear-gradient(180deg,#ffffff,#f8f6ef)" }}
      >
        <Container>
          <Card
            className="border-0 rounded-4 overflow-hidden shadow-xl"
            style={{
              background:
            ...
            <Row className="g-0 align-items-center">
              <Col lg={8} className="p-4 p-md-5">
                ...
                <p className="mb-0" style={{ color: "rgba(255,255,255,.78)" }}>
                  Stylist của Lily hỗ trợ 9:00–21:00 mỗi ngày · Gợi ý outfit
                  theo dịp, chất liệu & phom chân của bạn.
                </p>
              </Col>
